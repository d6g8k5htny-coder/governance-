...
| main [#98](https://github.com/d6g8k5htny-coder/main/pull/98) | `b59359e…` post-merge `semantic_digest_core` fix; **OA final readback OFFERED**; CI `36206280233`; prior tip OA E6 eng ACCEPT; serialize [#118](https://github.com/d6g8k5htny-coder/main/pull/118); #90 OPEN |
...
| main [#120](https://github.com/d6g8k5htny-coder/main/pull/120) | `7ed8d1e…` SIDE24 source-custody recovery; **observe**; no re-ratification |
