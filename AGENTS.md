...
- Coordinate via `main` campaign work and `governance-` contract.
...
- Cross-repo eng tests and Path C live in `d6g8k5htny-coder/trial`.
...
2. `governance-` working contract
3. `d6g8k5htny-coder/trial` → `docs/MULTI_AGENT_ACCESS.md`
